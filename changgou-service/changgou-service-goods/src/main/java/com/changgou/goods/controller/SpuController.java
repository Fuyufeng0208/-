...
public class SpuController {
    ...
    public Result<Spu>pullMany(@RequestBody Long[] ids){
        int count = spuService.pullMany(ids);
        return new Result<Spu>(true,StatusCode.OK,"成功下架"+count+"个商品");
    }
     ...
     */
    @PutMapping("put/{id}")
    public Result<Spu>put(@PathVariable(value = "id") long id){
        spuService.put(id);
        return new Result<Spu>(true,StatusCode.OK,"上架成功");
    }
     ...
     */
    @PutMapping("/put/many")
    public Result<Spu> putMany(@RequestBody Long[] ids){
        int count = spuService.putMany(ids);
        return new Result<Spu>(true,StatusCode.OK,"成功上架"+count+"个商品");
    }
}
