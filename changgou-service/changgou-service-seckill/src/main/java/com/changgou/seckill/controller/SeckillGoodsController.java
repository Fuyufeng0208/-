...
public class SeckillGoodsController {
    ...
    public Result<SeckillGoods> list(String time){
        ...
        return new Result<>(true,StatusCode.OK,"查询固定时间段内秒杀商品成功",list);
    }
     ...
     */
    @RequestMapping("/one")
    public Result<SeckillGoods> seckillGoods(Long id,String time){
        SeckillGoods seckillGoods = seckillGoodsService.findByIdToRedis(id,time);
        return new Result<>(true,StatusCode.OK,"根据id查询秒杀商品成功",seckillGoods);
    }
}
